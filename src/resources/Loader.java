...
public class Loader {
	public void load() {
		try {
			...
			Resources.TEXTURES.add(Resources.PLAYER_BACK,
					ImageIO.read(getClass().getResource("/image/player_back.png")));
			Resources.TEXTURES.add(Resources.PLAYER_BACK_2,
					ImageIO.read(getClass().getResource("/image/player_back_2.png")));
			Resources.TEXTURES.add(Resources.PLAYER_LEFT,
					ImageIO.read(getClass().getResource("/image/player_left.png")));
			Resources.TEXTURES.add(Resources.PLAYER_LEFT_2,
					ImageIO.read(getClass().getResource("/image/player_left_2.png")));
			Resources.TEXTURES.add(Resources.PLAYER_RIGHT,
					ImageIO.read(getClass().getResource("/image/player_right.png")));
			Resources.TEXTURES.add(Resources.PLAYER_RIGHT_2,
					ImageIO.read(getClass().getResource("/image/player_right_2.png")));
			...
			Resources.TEXTURES.add(Resources.MONSTER_ATTACK,
					ImageIO.read(getClass().getResource("/image/monster_attack.png")));
			...
			Resources.TEXTURES.add(Resources.GHOST_ATTACK,
					ImageIO.read(getClass().getResource("/image/ghost_attack.png")));
			Resources.TEXTURES.add(Resources.GHOST_INVISIBLE,
					ImageIO.read(getClass().getResource("/image/ghost_invi.png")));
			Resources.TEXTURES.add(Resources.GHOST_VISIBLE_2,
					ImageIO.read(getClass().getResource("/image/ghost_invi2.png")));
			...
			Resources.TEXTURES.add(Resources.F_MONSTER_2,
					ImageIO.read(getClass().getResource("/image/f_monster_2.png")));
