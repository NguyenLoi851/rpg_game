...
public class IntroMenu extends GameState {
	...
	public void Render(Graphics graphics) {
		// TODO Auto-generated method stub
		graphics.drawImage(Resources.TEXTURES.get(Resources.UNIVERSE), 0, 0, WindowManager.WIDTH, WindowManager.HEIGHT,
				null);
		...
		graphics.drawString("Đặc vụ Isra được cử đến hành tinh Pales để chiến đấu với kẻ thù", 60,
				WindowManager.HEIGHT * 3 / 4);
	}
