...
public class DaoLyMenu extends GameState {
	...
	public void Loop() {
		...
		time--;
		if (time >= 200)
			daoly = "Chiến tranh sẽ chỉ sinh ra chiến tranh";
		else if (time >= 100)
			daoly = "Thù hận sẽ chỉ sinh ra thù hận";
		else
			daoly = "Hãy kết thúc mọi thứ trong hòa bình";
		if (time == 0)
	...
	public void Render(Graphics graphics) {
		...
		graphics.drawImage(Resources.TEXTURES.get(Resources.HEART), WindowManager.WIDTH / 2, WindowManager.HEIGHT / 3,
